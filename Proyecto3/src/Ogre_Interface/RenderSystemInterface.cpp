...
/*
std::pair<SceneNode*, Entity*> RenderSystemInterface::createPlane(std::string name, Vector3 Normal,Real w, Real h, Vector3 up)
{
	try{
		...
		LogSystem::getSingleton()->Log("VECTORES INVALIDOS EN EL PLANO   "+ (std::string)e.what());
