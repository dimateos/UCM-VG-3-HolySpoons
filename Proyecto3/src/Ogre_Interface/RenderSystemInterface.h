...
public:
	 ...
	 */
	std::pair<Ogre::SceneNode*, Ogre::Entity*> createOgreEntity(std::string name, std::string meshName = "");
	/*
	 *Crea un nodo vacio
	 */
	 ...
	 */
	//std::pair<Ogre::SceneNode*, Ogre::Entity*> createPlane(std::string name, Ogre::Vector3 Normal, Ogre::Real w, Ogre::Real h, Ogre::Vector3 up);
	/*
